...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[22rem] -skew-y-[8deg] select-none flex-col justify-between rounded-xl border-2 border-voclira-burgundy/25 bg-voclira-paper shadow-[0_8px_30px_rgba(123,37,37,0.18)] px-4 py-3 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[20rem] after:bg-gradient-to-l after:from-voclira-cream/80 after:to-transparent after:content-[''] hover:border-voclira-burgundy/50 hover:bg-voclira-paper [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className
      )}
    >
      <div>
      ...
      <p className="whitespace-nowrap text-base text-voclira-burgundy/70">{description}</p>
